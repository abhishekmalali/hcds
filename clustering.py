###
#
# source: https://github.com/alexminnaar/time-series-classification-and-clustering/blob/master/clustering/ts_cluster.py
#
###
...
class ts_cluster(object):
	...
	def LB_Keogh(self,s1,s2,r):
		...
		for ind,i in enumerate(s1):
			...
			lower_bound=s2[(ind-r if ind-r>=0 else 0):(ind+r)].min()
			upper_bound=s2[(ind-r if ind-r>=0 else 0):(ind+r)].max()
